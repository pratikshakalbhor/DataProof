...
func RestoreFile(c *gin.Context) {
	...
	// Forensic Audit log
	LogAudit(record.WalletAddress, fileId, record.Filename, "FILE_RESTORED", record.TxHash, record.BlockNumber, "Forensic vault recovery completed from encrypted backup.")
